...
from exporters import get_epub_css, create_epub_chapter
...
def process_novel(novel_dir):
    ...
    for chapter_data in all_translated_data:
        ...
        epub_ch = create_epub_chapter(chapter_title_en, chapter.file_name, epub_body_html, epub_css)
