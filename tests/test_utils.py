...
class TestFilenameSanitization(unittest.TestCase):
    ...
    def test_spaces_to_underscores(self):
        ...
        self.assertEqual(
            sanitize_filename("Villainous Saintess"), "Villainous_Saintess"
        )
    ...
    def test_illegal_characters_removed(self):
        ...
        self.assertEqual(
            sanitize_filename("Star*Wars: A New Hope"), "StarWars_A_New_Hope"
        )
        self.assertEqual(
            sanitize_filename("My/Novel\\Path|Name<Tag>"), "MyNovelPathNameTag"
        )
